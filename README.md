...
- [Best Practice Active Directory Design for Managing Windows Networks](https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-2000-server/bb727085(v=technet.10))
- [Best practices for assigning permissions on Active Directory objects](https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2003/cc786285(v=ws.10))
...
- [Location Mapping](https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-2000-server/bb727034(v=technet.10))
